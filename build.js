...
// @namespace    https://github.com/amarokdevs/gemini-watermark-remover
// @version      0.1.6
...
const copyAssetsPlugin = {
  ...
  setup(build) {
    build.onEnd(() => {
      ...
      try {
        if (!existsSync('dist/dpk')) mkdirSync('dist/dpk', { recursive: true });
        cpSync('src/dpk', 'dist/dpk', { recursive: true });
